...
public class Q2_chrm_snpdl {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//input[@name='keyword'])[1]")).sendKeys("iphone 7");
		Thread.sleep(3000);
		...
		addCart.click();
		Thread.sleep(3000);
		WebElement costOfProduct = driver.findElement(By.xpath("//div[@class='you-pay']"));
